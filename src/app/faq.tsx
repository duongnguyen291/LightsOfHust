...
const FAQS = [
  ...
  },
  {
    ...
    desc: "Những bài dự thi xuất sắc nhất sẽ được Ban Tổ Chức chọn lọc trong vòng sơ loại và tiến vào vòng chung kết. 10% số lượng video có điểm cao nhất sẽ được đăng tải lên trang sự kiện để bình chọn. Kết quả cuối cùng sẽ được quyết định dựa trên tổng điểm từ Ban Giám Khảo và điểm tương tác (lượt like, reaction, comment, và share) từ khán giả trong 5 ngày đầu tiên sau khi bài được đăng",
  },
];
      ...
      <div className="container mx-auto">
        <div className="text-center">
          ...
          <Typography
            ...
            onPointerLeaveCapture={() => {}}
          >
            Chào mừng bạn đến với phần Câu hỏi thường gặp về sự kiện Lights of
            HUST. Chúng tôi ở đây để giải quyết các câu hỏi phổ biến nhất của
            bạn và cung cấp cho bạn thông tin bạn cần để tận dụng tối đa trải
            nghiệm với sự kiện.
          </Typography>
        </div>
