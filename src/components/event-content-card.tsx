...
export function EventContentCard({
  ...
  return (
    <Card
      color="transparent"
      shadow={false}
      className="lg:!flex-row mb-10 lg:items-end" placeholder=""onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}
    >
      <CardHeader
        floated={false}
        shadow={false}
        className="h-[32rem] max-w-[28rem] shrink-0" placeholder=""onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}
      >
        <Image
          width={768}
          height={768}
      ...
      <CardBody className="col-span-full lg:col-span-3" placeholder=""onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
        ...
        <div className="flex items-center gap-4">
          <Avatar
            ...
            src="/logos/soict.jpg"
            alt="soict"
            size="lg" placeholder=""onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}
          />
          <div>
